...
| Capacity | The amount of waste product produced on a time basis (e.g. 1000 tonnes per year). <br> *note: check the ADAM product database to see which units each product is in.* |
